...
export const seriousProjects: Project[] = [
  ...
  {
    id: 5,
    title: "FindYourFixer - Service Marketplace",
    description:
      "A comprehensive full-stack service marketplace connecting users with verified local professionals across 13+ categories (electricians, plumbers, tailors, hair stylists, etc.). Features real-time messaging with Socket.io, face verification for professionals using Face-api.js, geo-location filtering with Leaflet maps, job posting system, payment integration, professional profiles with ratings, advanced search functionality, and responsive design.",
