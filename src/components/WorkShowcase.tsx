...
const WorkShowcase = () => {
  ...
  return (
    <section id="projects" className="relative py-24 lg:py-40 bg-black text-[#E2E1DF] px-6 lg:px-16 overflow-hidden">
          ...
          {activeTab === "serious" ? (
            ...
            >
              ...
              <div className="relative transform hover:rotate-1 transition-transform duration-700">
                ...
                <div className="relative w-[340px] h-[680px] bg-[#050505] rounded-[3rem] p-3 shadow-2xl border border-[#222] ring-1 ring-white/5">
                  {/* Inner Screen Border */}
